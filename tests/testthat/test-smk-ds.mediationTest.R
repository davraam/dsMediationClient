...
test_that("simple mediationTest", {
    ...
    expect_equal(res$study1$Sobel[1], 4.321360678, tolerance = ds.test_env$tolerance)
    expect_equal(class(res$study1$Sobel[2]), "numeric")
    expect_equal(res$study1$Sobel[2], 0.000015507, tolerance = ds.test_env$tolerance)
    expect_length(res$study1$Aroian, 2)
    expect_equal(class(res$study1$Aroian[1]), "numeric")
    expect_equal(res$study1$Aroian[1], 4.319228e+00, tolerance = ds.test_env$tolerance)
    expect_equal(class(res$study1$Aroian[2]), "numeric")
    expect_equal(res$study1$Aroian[2], 1.565762e-05, tolerance = ds.test_env$tolerance)
    expect_length(res$study1$Goodman, 2)
    expect_equal(class(res$study1$Goodman[1]), "numeric")
    expect_equal(res$study1$Goodman[1], 4.323497e+00, tolerance = ds.test_env$tolerance)
    expect_equal(class(res$study1$Goodman[2]), "numeric")
    expect_equal(res$study1$Goodman[2], 1.535753e-05, tolerance = ds.test_env$tolerance)
    ...
    expect_equal(res$study2$Sobel[1], -0.3498626, tolerance = ds.test_env$tolerance)
    expect_equal(class(res$study2$Sobel[2]), "numeric")
    expect_equal(res$study2$Sobel[2], 0.7264418, tolerance = ds.test_env$tolerance)
    expect_length(res$study2$Aroian, 2)
    expect_equal(class(res$study2$Aroian[1]), "numeric")
    expect_equal(res$study2$Aroian[1], -0.3061303, tolerance = ds.test_env$tolerance)
    expect_equal(class(res$study2$Aroian[2]), "numeric")
    expect_equal(res$study2$Aroian[2], 0.7595054, tolerance = ds.test_env$tolerance)
    expect_length(res$study2$Goodman, 2)
    expect_equal(class(res$study2$Goodman[1]), "numeric")
    expect_equal(res$study2$Goodman[1], -0.4200051, tolerance = ds.test_env$tolerance)
    expect_equal(class(res$study2$Goodman[2]), "numeric")
    expect_equal(res$study2$Goodman[2], 0.6744817, tolerance = ds.test_env$tolerance)
    ...
    expect_equal(res$study3$Sobel[1], 0.2442042, tolerance = ds.test_env$tolerance)
    expect_equal(class(res$study3$Sobel[2]), "numeric")
    expect_equal(res$study3$Sobel[2], 0.8070727, tolerance = ds.test_env$tolerance)
    expect_length(res$study3$Aroian, 2)
    expect_equal(class(res$study3$Aroian[1]), "numeric")
    expect_equal(res$study3$Aroian[1], 0.1345419, tolerance = ds.test_env$tolerance)
    expect_equal(class(res$study3$Aroian[2]), "numeric")
    expect_equal(res$study3$Aroian[2], 0.8929741, tolerance = ds.test_env$tolerance)
